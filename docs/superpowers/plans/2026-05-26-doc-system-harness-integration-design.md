...
- Agent and hook files reference paths relative to the harness root (e.g., `docs/manifest.json`, `hooks/doc-manifest-validator.sh`)
...
- Add instruction: "Before creating a new design, check `docs/manifest.json` for existing or similar designs"
...
- Add instruction: "Upon starting implementation, read `docs/manifest.json` and find design entry"
- Add instruction: "Move design state from proposed→inprogress in manifest, set inprogress_since=today"
- Add instruction: "Create `docs/inprogress/{design_name}-progress.md` mirroring design structure"
...
- Add instruction: "On PASS: move design state from inprogress→completed in `docs/manifest.json`"
- Add instruction: "Move progress doc from `docs/inprogress/` to `docs/reference/` for archival"
...
|---------------|------|---------|
| `docs/manifest.json` | NEW | Central registry of doc states |
| `docs/README.md` | NEW | System guide and agent instructions |
| `docs/proposed/` | NEW DIR | Staging area for new designs |
| `docs/inprogress/` | NEW DIR | Active designs + progress docs |
| `docs/completed/` | NEW DIR | Completed designs awaiting archival |
| `docs/reference/` | NEW DIR | Historical archive |
