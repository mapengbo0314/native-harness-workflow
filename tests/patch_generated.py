...
hooks = [
    (".claude/plugin-generated/src/hooks/prompt_interceptor.py", "prompt_interceptor", """if __name__ == "__main__":
    import sys
    if len(sys.argv) > 1:
        print(intercept(sys.argv[1]))"""),
        
    (".claude/plugin-generated/src/hooks/pre_tool_guard.py", "pre_tool_guard", """if __name__ == "__main__":
    import sys
    if len(sys.argv) > 2:
        check_tool_use(sys.argv[1], sys.argv[2])"""),
        
    (".claude/plugin-generated/src/hooks/stop_monitor.py", "stop_monitor", """if __name__ == "__main__":
    import sys
