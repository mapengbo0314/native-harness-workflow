...
# .mcp.json is emitted too (generated by compile_mcp_config from the mcp_servers.json
# catalog + feature flags; no single template source).
...
_BOILERPLATE_FILES: dict[str, tuple[str, str, str]] = {
    ...
    # Operator-editable MCP server catalog (source of truth for the emitted .mcp.json).
    "mcp_servers.json": ("customizable", "template", "templates/boilerplate/mcp_servers.json"),
}
