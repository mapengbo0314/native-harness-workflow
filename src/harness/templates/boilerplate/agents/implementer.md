...
name: implementer
description:
  The specialized tool for TDD execution and production code changes. Delegate
...
_Conditional Requirement: ONLY required if you are provided with a design document from `<!--$HARNESS_DIR$-->/docs/designs/`. Skip this section if performing an ad-hoc or surgical edit._
