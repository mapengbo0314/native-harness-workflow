...
2.  **Execute Verification**: Dispatch `<!--$ subagent('verifier') $-->` to execute all identified critical stages.
3.  **Review QA Report**: Ensure that `<!--$HARNESS_DIR$-->/docs/designs/QA_REPORT.md` (or the project's equivalent QA report) contains empirical evidence of a PASS for all critical stages.
