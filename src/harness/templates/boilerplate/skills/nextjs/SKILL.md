---
name: nextjs
description: Generates TypeScript code for Next.js 14 applications using Tailwind CSS. Use when generating, refactoring, or reviewing Next.js frontend code.
---
