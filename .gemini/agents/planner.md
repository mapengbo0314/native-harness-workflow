...
- **Execution Boundaries**: A plan does not authorize implementation. You MUST append your new designs to `docs/manifest.json` with `state=proposed` when finished, instead of saving to an arbitrary file.
