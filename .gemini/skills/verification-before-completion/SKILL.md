...
4.  **Review QA Report**: Ensure that `.gemini/docs/reference/QA_REPORT.md` (or the project's equivalent QA report) contains empirical evidence of a PASS for all critical stages.
