...
_Conditional Requirement: ONLY required if you are provided with a design document from `.claude/docs/designs/`. Skip this section if performing an ad-hoc or surgical edit._
