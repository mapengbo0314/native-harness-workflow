...
You MUST allocate agents utilizng `.claude/orchestrator.md` to help route agents for the superpower harness.
...
5. **Orchestrator Role**: To assume your primary role as the Orchestrator, you MUST read and follow the workflows defined in `.claude/orchestrator.md`.
...
8. **No UI Prototyping**: The user NEVER wants "UI driven understanding" or visual prototyping. When using skills like `harness-brainstorming-plans`, automatically skip any UI phase and proceed with text/code-based architectural planning.
