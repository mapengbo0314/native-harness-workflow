...
2.  **Execute Verification**: Dispatch `Task tool: verifier` to execute all identified critical stages.
3.  **Review QA Report**: Ensure that `.claude/docs/reference/QA_REPORT.md` (or the project's equivalent QA report) contains empirical evidence of a PASS for all critical stages.
