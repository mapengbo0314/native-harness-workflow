...
3.  **Review QA Report**: Ensure that `.claude/artifacts/QA_REPORT.md` (or the project's equivalent QA report) contains empirical evidence of a PASS for all critical stages.
