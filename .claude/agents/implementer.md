...
- **Stack Trace Hook**: Before reading large log files, you MUST run `run_shell_command("python .claude/scripts/extract_stacktrace.py <logfile>")` to minimize context usage.
